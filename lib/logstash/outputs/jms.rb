...
@jms_session_pool = connection.create_session_pool(@jms_config)

#TODO(AlphaCluster) Attempting producer caching... More work needed.
#		connection = JMS::Connection.new(@jms_config)
#    session = connection.create_session()
#
#    if @queue_name.nil?
#	    @producer = session.producer(:queue_name => @queue_name)
#	  else
